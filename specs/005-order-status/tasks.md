...
- [x] **T001 — DTO contract**: Add validated `page`, `limit`, and optional
  `status` query DTOs plus paginated response DTOs; document every existing
  `EstadoOrden` value — `application/dto/order.dto.ts`

- [x] **T002 — Scoped read flow**: Add safe repository/service list and detail
...
- [x] **T003 — Focused proof**: Extend the existing order unit/contract specs to
...
- [x] **T004 — Validation and stop**: Run build, focused ESLint, and the three
